(() => {
  ...
  const stepSliderEl = document.getElementById("selection-step-slider");
  const playBtn = document.getElementById("selection-play");
  const stopBtn = document.getElementById("selection-stop");
  const prevBtn = document.getElementById("selection-prev");
  const nextBtn = document.getElementById("selection-next");
  const firstBtn = document.getElementById("selection-first");
  const lastBtn = document.getElementById("selection-end");
